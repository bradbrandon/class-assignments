...
class cantern:
        ...
        def printall(self):  
            print("Reciept for : ",self.studname ,"  ",self.studsurname,"\n contact details:",self.studco_detail,"program of study: ",self.studprogram )
...
hit_canteen=cantern(input("enter the student name",),input("enter the student surname",),input("enter the student contact details",),input("enter the program of study",))
